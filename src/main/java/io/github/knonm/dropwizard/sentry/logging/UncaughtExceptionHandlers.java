...
/**
 * Simple factory for a {@link UncaughtExceptionHandler} which logs the last
 * uncaught exception with a SLF4J {@link Logger} on ERROR level.
 *
...
public final class UncaughtExceptionHandlers {
     ...
     * </pre>
     *
     * @return UncaughtExceptionHandler An exception handler that will log
     * before exiting
     */
